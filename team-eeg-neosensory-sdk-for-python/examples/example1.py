...
async def run(loop):
    ...
    async with BleakClient(buzz_addr, loop=loop) as client:
        ...
        # the following list contains dummy muse data. For the sake of demo, each list of data will be 
        # arbitrarily converted into values to 
        dummyMuseData = [45.41015625, 32.71484375, 0.0, 0.0, 0.0, 1638398381.5694199]

        illusion_intensity = dummyMuseData[0] / 100
